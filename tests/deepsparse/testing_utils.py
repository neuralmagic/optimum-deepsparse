...
MODEL_DICT = {
    ...
    # audio models
    "audio_spectrogram_transformer": ModelInfo(
        "Ericwang/tiny-random-ast", DEFAULT_TOKEN_SHAPES, DEFAULT_PADDING_KWARGS
    ),
    ...
    "unispeech_sat": ModelInfo(
        "hf-internal-testing/tiny-random-UnispeechSatModel", DEFAULT_TOKEN_SHAPES, DEFAULT_PADDING_KWARGS
    ),
    "wavlm": ModelInfo("hf-internal-testing/tiny-random-WavlmModel", DEFAULT_TOKEN_SHAPES, DEFAULT_PADDING_KWARGS),
    "wav2vec2": ModelInfo(
        "hf-internal-testing/tiny-random-Wav2Vec2Model", DEFAULT_TOKEN_SHAPES, DEFAULT_PADDING_KWARGS
    ),
    "wav2vec2-conformer": ModelInfo(
    ...
    # stable diffusion
    "stable-diffusion": ModelInfo("hf-internal-testing/tiny-stable-diffusion-torch"),
    "stable-diffusion-xl": ModelInfo("echarlaix/tiny-random-stable-diffusion-xl"),
    "stable-diffusion-xl-refiner": ModelInfo("echarlaix/tiny-random-stable-diffusion-xl-refiner"),
}
